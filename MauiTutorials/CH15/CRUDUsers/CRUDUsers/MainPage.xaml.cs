...
namespace CRUDUsers
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage(DataContext dataContext) //pass in a dataContext object automatically
        {
            InitializeComponent();
            _dataContext = dataContext;
            Users = new ObservableCollection<User>();
            BindingContext = this; //MVVM pattern-user interface bound to the code behind.
            LoadUsers();
        }
        private async void LoadUsers()
        {
            try
            {
                await _dataContext.Database.EnsureCreatedAsync(); //ensure the database is created
